...
export default defineConfig({
  ...
  description: 'SnipKit helps you to execute scripts saved in your favorite snippets manager without even leaving the terminal.',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2024 lemoony'
    },
