...
```sh:line-numbers [Example snippet]
# some comment
...
::: tip Default parameter name and type
...
```sh:line-numbers [Example snippet with a parameter default value]
# some comment
...
```sh:line-numbers [Example snippet with pre-defined values for a parameter]
# some comment
...
```sh:line-numbers [Example snippet with a PASSWORD parameter]
...
```sh:line-numbers [Example snippet with a PATH parameters]
# ${FILE} Name: File path
# ${FILE} Type: PATH
